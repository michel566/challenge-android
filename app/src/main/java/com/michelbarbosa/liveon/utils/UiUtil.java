...
public class UiUtil {
    ...
    public static void dotPagerGenerator(final Context context, ViewPager viewPagerTarget,
                                         ViewGroup container, final int adapterCount) {
        final ImageView[] dots = new ImageView[adapterCount];
        ...
        viewPagerTarget.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
